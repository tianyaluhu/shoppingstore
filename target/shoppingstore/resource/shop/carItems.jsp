...
<head>
    ...
    <style>
        ...
        label .mark{
            /*当你设置了no-repeat这个属性后，你的背景图将不会被重复*/
...
<script type="text/javascript">
    ...
    $(function (){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $("section").on("click","label",function () {
                    ...
                    }else if(!flag&&(lid=='firstLabel')){/*取消全选*/
        ...
        $(".cartBox").on("blur",".sum",function(){
            ...
            $(this).parent().parent().parent().children().eq(0).find("label").attr("pnum",$(this).val());
