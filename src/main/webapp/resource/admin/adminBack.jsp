...
<script>
    ...
    $(function(){
        ...
        $("#takeoff").click(function(){
            $("#myframe").attr("src","resource/products/takeoff.jsp");
        });

        $("#undeliver").click(function(){
            $("#myframe").attr("src","resource/products/unDeliverOrders.jsp");
        });

        $("#backdeliver").click(function(){
            $("#myframe").attr("src","resource/products/backDeliverOrders.jsp");
        });
